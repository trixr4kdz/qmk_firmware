...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_4x6_5(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, /*                 */ KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
                             ...
                             //-----------------------------------------------------//-----------------------------------------------------------//
                             KC_LSFT, KC_SPC, TG(1), /*                               */ TG(2), KC_ENT, KC_RGUI,
                             //-----------------------------------------------------//-----------------------------------------------------------//
                             KC_TAB, KC_BSPC, /*                                      */ KC_DEL, KC_RCTL),
    ...
    [2] = LAYOUT_split_4x6_5(KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, /*             */ KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
                             //-----------------------------------------------------//-----------------------------------------------------------//
                             _______, _______, RGB_RMOD, RGB_TOG, RGB_MOD, _______, /* */ _______, _______, _______, _______, _______, KC_MUTE,
                             //-----------------------------------------------------//-----------------------------------------------------------//
...
void keyboard_post_init_user(void) {
    ...
    rgblight_sethsv_noeeprom(HSV_WHITE); // Start-up color

    // TODO: set static rainbow gradient as default color
}
